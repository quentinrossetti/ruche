...
repository\'s server is down or your configuration wrong.'
  ...
  112 : {
    message: 'No package to extract',
    more: '\
The task you specified can\'t be done because there is no archive to extract.'
...
Ruche tried to save a file failed.'
  ...
  213: {
    message: 'Invalid gz file',
    more: '\
Ruche tried to parse a gz file and failed. This likely occurs because the \
file is not a valid gz archive.'
    // data: { file: invalidFile }
  },
  ...
  214: {
    ...
    more: '\
Ruche tried to parse a tar file and failed. This likely occurs because the \
file is not a valid tar archive.'
    // data: { file: invalidFile }
  },
...
specify.'
  ...
  231: {
    message: 'Unable to register binaries',
    more: '\
Check your configuration. If the problem persists maybe the ruche.json or the \
archive you tried to register is invalid, in this case contact the repository\'\
s owner.'
    // data: { software: invalidSoftware }
  }
